          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                ...
                <span>Course Handler</span>
                <span class="label label-primary pull-right">4</span>
              </a>
              <ul class="treeview-menu">
                <li><a href="index.php?action=Universities"><i class="fa fa-circle-o"></i> Universities</a></li>
...
?>
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; <?php if(date('Y')=='2015'){echo'2015';}else{echo'2015-'.date('Y');} ?> 
		<a href=https://icon256bliss.com>ICON256</a>.</strong> All rights reserved.
    </footer>
